    ...
    <div class="layui-header header header-demo">
        <div class="layui-main">
            <div class="admin-logo-box">
                <a class="logo" href="" title="logo">大学生就业信息管理系统</a>
    ...
    <div class="layui-side layui-bg-black x-side show_list" style="left:0px;" id="table1">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;" _href="#"> <i class="layui-icon left-nav-li" lay-tips="首页">&#xe68e;</i><cite>控制台</cite> </a>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="iconfont icon-dashaxiaoqudizhi01" style="top: 3px;"></i><cite>学生管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="communitylist.html"> <cite>学生列表</cite> </a> </dd>
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="communitylist.html"> <cite>反馈信息</cite> </a> </dd>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-lvhuaxiaoqu" style="top: 3px;"></i><cite>企业管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="homelist.html"> <cite>企业公告</cite> </a> </dd>
                        </dd>
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="buildinglst.html"> <cite>企业列表</cite> </a> </dd>
                        </dd>
